 ...
 * 
 */
public class RowComparatorAbsoluteSimilarity extends RowKBComparator{

	private static final long serialVersionUID = 1L;
	AbsoluteDifferenceSimilarity sim = null;

	private ComparatorLogger comparisonLog;
	private boolean squared;
	private double threshold;

	public RowComparatorAbsoluteSimilarity(double threshold, boolean squared, double maxDifference) {
		this.sim = new AbsoluteDifferenceSimilarity(maxDifference);
