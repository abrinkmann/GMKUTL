 ...
 * 
 */
public class RowComparatorJaccard extends StringComparator {
	...
	public RowComparatorJaccard(double threshold, boolean squared, boolean lower, boolean removeBrackets) {
