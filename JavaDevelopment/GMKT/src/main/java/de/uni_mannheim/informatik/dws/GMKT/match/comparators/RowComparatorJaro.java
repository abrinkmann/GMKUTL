...
import de.uni_mannheim.informatik.dws.GKT.similarity.JaroSimilarity;
 ...
 * {@link JaroSimilarity} similarity.
 * 
 * @author Alexander Brinkmann (albrinkm@mail.uni-mannheim.de)
 * 
 */
public class RowComparatorJaro extends StringComparator {
	
	public RowComparatorJaro(double threshold, boolean squared, boolean lower, boolean removeBrackets) {
