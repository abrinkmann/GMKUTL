 ...
 * 
 */
public class RowComparatorLevenshtein extends StringComparator {
	...
	public RowComparatorLevenshtein() {
		setLowerCase(true);
		setRemoveBrackets(true);
	}

	public RowComparatorLevenshtein(double threshold, boolean squared, boolean lower, boolean removeBrackets) {
